...
class MyLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      "days": "Days",
      "delete": "Delete",
      "download_folder_as_html": "Generate HTML links",
      ...
      "share_folder_view": "Share folder view",
    ...
    'fr': {
      ...
      "days": "Jours",
      "delete": "Supprimer",
      "download_folder_as_html": "Générer des liens html",
      "download_folder_as_zip": "Télécharger comme zip",
      ...
      "share_folder_view": "Partager une vue du dossier",
